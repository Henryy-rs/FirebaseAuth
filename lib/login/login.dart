...
import 'package:firexample/login/email_login.dart';
import 'package:firexample/login/login_text.dart';
import 'package:firexample/main.dart';
import 'package:firexample/sign_up/sign_up.dart';
import 'package:firexample/widgets/submit_button.dart';
    ...
    try {
      ...
      switch (e.code) {
        ...
        case 'operation-not-allowed':
          ...
          break;
        case 'user-disabled':
          title = 'The user tried to log into is disabled';
          break;
        case 'user-not-found':
          title = 'The user you tired to log into was not found';
          break;
      }
